...
var (
	...
	ErrSignedSizeMismatch         = errors.New("the signed tree-size-2 does not match the declared consistency proof size")
	ErrSignedSizeMissing          = errors.New("the protected header carries no signed tree-size-2")
	ErrProtectedHeaderInvalid     = errors.New("the protected header is not canonical cbor of the expected shape")
